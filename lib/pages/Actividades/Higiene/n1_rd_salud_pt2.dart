...
class n1_rd_salu extends State {
                          ...
                          children: [
                            ToggleSwitch(
                              ...
                              onToggle: (index) {
                                ...
                                if (index == 0) {
                                  audioUrl =
                                      "assets/audios/nos_lavamos_las_manosH.mp3";
                                } else {
                                  if (index == 1) {
                                    audioUrl = "";
                                  }
                    ...
                    children: [
                      Container(
                        ...
                        child: salud_abrir_animacion(
                          ...
                          heigth: 200,
                          onTap: () {
                            //esto son las acciones que hará cuando se de click en la imagen
                            soundpool();
                                      ...
                                      child: salud_abrir_animacion(
                                        ...
                                        onTap: () {
                                          Navigator.of(context)
                                              .pop(); //hace que regrese a la ultima ventana
                                        },
                                      ),
                                    ),
                                  );
  ...
  Future<void> soundpool() async {
    ...
    int soundId = await rootBundle
        .load('assets/img/torettoabrir.wav')
  ...
  Future<void> soundpool2() async {
    ...
    int soundId =
        await rootBundle.load('assets/img/agua.wav').then((ByteData soundData) {
      return pool.load(soundData);
    });
    int streamId = await pool.play(soundId);
  } //fin soundpool2
