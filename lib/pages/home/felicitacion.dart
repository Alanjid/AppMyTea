...
class felicitacion extends StatefulWidget {
  ...
  final double width;
  final double heigth;
  felicitacion({required this.photo, required this.width, required this.heigth})
      : super();
  @override
  felicitacion2 createState() =>
      felicitacion2(photo: photo, width: width, heigth: heigth);
}

class felicitacion2 extends State {
  felicitacion2(
      {required this.photo, required this.width, required this.heigth})
      : super();
...
Future<void> soundpool() async {
  ...
  int soundId = await rootBundle
      .load('assets/audios/bien_hecho.mp3')
